...
import { CLAUDE_AGENT_SDK_CLI_ENVIRONMENT, CLAUDE_AGENT_SDK_ROOT_ENVIRONMENT, inspectClaudeAgentSdkInstallation, } from "./claude-agent-sdk.js";
...
async function claudeAgentSdkCheck() {
    try {
