...
- **Status:** Developer-preview implementation available; remote provider, Windows, clean-worktree retention, external wake/reattachment, restack, and cross-platform fault-injection acceptance remains pending
- **Date:** 2026-08-22
